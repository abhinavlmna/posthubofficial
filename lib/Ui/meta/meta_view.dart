...
import 'meta_viewmodel.dart';

class MetaView extends StatelessWidget {
  MetaView({Key? key}) : super(key: key);
  int sliderIndex = 0;
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<MetaViewModel>.reactive(
      ...
      viewModelBuilder: () => MetaViewModel(),
    );
  }
